...
export function useTimeEntries() {
  ...
  const activeEntry = entries.length > 0 
    ? entries.sort((a, b) => b.timestamp.getTime() - a.timestamp.getTime())
        .find(entry => entry.type === "entrada" || entry.type.startsWith("pausa"))
    : null
  ...
  const addEntry = useCallback(async (
    ...
    setIsLoading(true)
    try {
      const newEntry = await createTimeEntryClient(type, new Date(), notes)
